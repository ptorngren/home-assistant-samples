...
- **ChatGPT** — for a second opinion and review.
- **Github Copilot** — initially used for coding in VS Code until replaced by Claude Code
...
The AI tools acted as accelerators and technical collaborators, not replacements for design thinking or testing.
